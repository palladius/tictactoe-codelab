...
public abstract class TictactoeRequest<T> extends AbstractGoogleJsonClientRequest<T> {
  ...
  public TictactoeRequest(
      Tictactoe client, String method, String uriTemplate, Object content, Class<T> responseClass) {
    super(
        client,
        method,
        uriTemplate,
 ...
 * reports. Required unless you provide an OAuth 2.0 token.
 */
  public TictactoeRequest<T> setKey(String key) {
    this.key = key;
    return this;
  }
 ...
 */
  ...
  @Override
  public final Tictactoe getAbstractGoogleClient() {
    return (Tictactoe) super.getAbstractGoogleClient();
  }

  @Override
  public TictactoeRequest<T> setDisableGZipContent(boolean disableGZipContent) {
    return (TictactoeRequest<T>) super.setDisableGZipContent(disableGZipContent);
  }

  @Override
  public TictactoeRequest<T> setRequestHeaders(HttpHeaders headers) {
    return (TictactoeRequest<T>) super.setRequestHeaders(headers);
  }
}
